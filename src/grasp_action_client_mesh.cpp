...
void done_cb(const actionlib::SimpleClientGoalState& state,
            const sr_grasp_mesh_planner::graspMeshResultConstPtr& result)
{
...
void feedback_cb(const sr_grasp_mesh_planner::graspMeshFeedbackConstPtr& feedback)
{
...
int main (int argc, char **argv)
{
  ...
  sr_grasp_mesh_planner::graspMeshGoal goal;
  ...
  actionlib::SimpleActionClient<sr_grasp_mesh_planner::graspMeshAction> ac("sr_grasp_mesh_planner", true);
